...
_lr_productions = [
  ...
  ('labeled_edge -> DASH edge_condition DASH GREATERTHAN','labeled_edge',4,'p_labeled_edge','cypher_parser.py',363),
  ('labeled_edge -> LESSTHAN DASH edge_condition DASH','labeled_edge',4,'p_labeled_edge','cypher_parser.py',364),
  ('literals -> node_clause','literals',1,'p_literals','cypher_parser.py',376),
  ('literals -> literals COMMA literals','literals',3,'p_literals','cypher_parser.py',377),
  ('literals -> literals RIGHT_ARROW literals','literals',3,'p_literals','cypher_parser.py',378),
  ('literals -> literals LEFT_ARROW literals','literals',3,'p_literals','cypher_parser.py',379),
  ('literals -> literals labeled_edge literals','literals',3,'p_literals','cypher_parser.py',380),
  ('match_where -> MATCH literals','match_where',2,'p_match_where','cypher_parser.py',425),
  ('match_where -> MATCH literals where_clause','match_where',3,'p_match_where','cypher_parser.py',426),
  ('create_clause -> CREATE literals','create_clause',2,'p_create','cypher_parser.py',436),
  ('full_query -> match_where return_variables','full_query',2,'p_full_query','cypher_parser.py',441),
  ('full_query -> create_clause','full_query',1,'p_full_query','cypher_parser.py',442),
  ('full_query -> create_clause return_variables','full_query',2,'p_full_query','cypher_parser.py',443),
  ('return_variables -> RETURN KEY','return_variables',2,'p_return_variables','cypher_parser.py',450),
  ('return_variables -> RETURN keypath','return_variables',2,'p_return_variables','cypher_parser.py',451),
  ('return_variables -> return_variables COMMA KEY','return_variables',3,'p_return_variables','cypher_parser.py',452),
  ('return_variables -> return_variables COMMA keypath','return_variables',3,'p_return_variables','cypher_parser.py',453),
]
